...
<div class="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100 py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-4xl mx-auto">
        <!-- Header -->
        <div class="mb-8">
            <h1 class="text-4xl font-bold text-gray-900 mb-2">Editar Evento</h1>
            <p class="text-gray-600">Preencha os dados abaixo para Editar o seu evento na plataforma</p>
        </div>
        ...
        <div class="bg-white rounded-lg shadow-lg p-8">
            <form action="{{ route('Evento-update',['id'=>$evento->id]) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                @csrf
                @method('PUT')
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <select 
                                ...
                                <option value="musica" {{ old('categoria', $evento->categoria) == 'musica' ? 'selected' : '' }}>Música</option>
                                <option value="teatro" {{ old('categoria', $evento->categoria) == 'teatro' ? 'selected' : '' }}>Teatro</option>
                                <option value="esportes" {{ old('categoria', $evento->categoria) == 'esportes' ? 'selected' : '' }}>Esportes</option>
                                <option value="negocios" {{ old('categoria', $evento->categoria) == 'negocios' ? 'selected' : '' }}>Negócios</option>
                                <option value="tecnologia" {{ old('categoria', $evento->categoria) == 'tecnologia' ? 'selected' : '' }}>Tecnologia</option>
                                <option value="arte" {{ old('categoria', $evento->categoria) == 'arte' ? 'selected' : '' }}>Arte</option>
                                <option value="educacao" {{ old('categoria', $evento->categoria) == 'educacao' ? 'selected' : '' }}>Educação</option>
                ...
                <div>
                    ...
                    <div>
                        ...
                        <textarea 
                            ...
                            placeholder="Descreva detalhadamente seu evento...">{{ old('descrição', $evento->descrição) }}</textarea>
                        @error('descrição') 
                            <span class="text-red-500 text-sm mt-1 block">{{ $message }}</span> 
                        @enderror
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                value="{{ old('data_inicio', $evento->data_inicio) }}"
                        ...
                        <div>
                            ...
                            <input 
                                ...
                                name="data_fim" 
                                id="data_fim"
                                value="{{ old('data_fim', $evento->data_fim) }}"
                        ...
                        <div class="md:col-span-2">
                            ...
                            <input 
                                ...
                                value="{{ old('localização', $evento->localização) }}"
